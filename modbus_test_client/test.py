    ...
    async with AsyncModbusTcpClient(host='10.0.0.78', port=502) as client:
        try:
            ...
            if connected:
                ...
                result = await client.read_holding_registers(address=2, count=1, slave=20)
                ...
                logger.debug("Writing value 2 to register at address 2, slave 20 using write_register")
                ...
                logger.debug("Writing value 5 to 1 register at address 2, slave 20 using write_registers")
